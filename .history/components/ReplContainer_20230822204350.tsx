...
const StatPill = (title: string, icon: React.ReactElement, value: number | string): JSX.Element => {
  return (
    <>
      <div
        css={[
    ...
    >
      ...
      >
        ...
        <AccordionItem
          ...
          css={[rcss.ml(48), { width: "fit-content" }]}
        >
          <StatPill title="Like Count" icon={<icons.Heart />} value={replData.repl.likeCount} />
        </AccordionItem>
      </AccordionItem>
    </li>
  );
