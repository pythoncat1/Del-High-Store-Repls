  ...
  return (
    <Modal isOpen={isOpen} onRequestClose={handleClose}>
      <div css={[rcss.mb(24)]}>
        ...
        <Text>
          Some Repls may take a few minutes to finish deleting.
        </Text>
      </div>
      <div css={[rcss.flex.row, rcss.rowWithGap(12)]}>
        <Button text="Cancel" onClick={handleClose} />
        <Button iconLeft={<icons.Trash />} colorway="red" text="Yes, delete this Repl" onClick={() => { handleDeleteRepl(), handleClose() }} />
      </div>
    </Modal>
  );
}
