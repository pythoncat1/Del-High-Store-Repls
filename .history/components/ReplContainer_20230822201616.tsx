import { rcss, icons, Surface, Text, IconButton, AccordionItem, Pill } from "../rui";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div css={[rcss.ml(48), rcss.flex.row, { width: "fit-content", alignItems: "center" }]}>
          <Text>Likes: <Pill>{replData.repl.likeCount}</Pill></Text>
        </div>
      </AccordionItem>
    </li>
  );
