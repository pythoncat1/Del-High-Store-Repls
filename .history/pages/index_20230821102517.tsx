...
const Home: NextPage = () => {
  ...
  const [repls, setRepls] = React.useState<null | GraphQLTypes.ManageAccountStorageUtilizationCurrentUserQuery["currentUser"]["storageInfo"]["accountStorageUtilization"][""]>(null);
